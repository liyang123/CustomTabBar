...
#pragma mark - 给当前view设置圆角，边框，边框颜色
...
#pragma mark - 给当前的view设置渐变色
- (void)lyAddLinearGradientToSelfWithColor:(UIColor *)theColor transparentToOpaque:(BOOL)transparentToOpaque
{
...
#pragma mark - 快速获取XIB初始化的View
+ (instancetype)lyGetViewFromXIB
{
